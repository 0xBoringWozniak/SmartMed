...
class DownloadWindowCross(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonDownload.setGeometry(QtCore.QRect(30, 310, 241, 31))
        ...
        self.pushButtonDownload1.setGeometry(QtCore.QRect(30, 360, 241, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonDownload.setText(_translate("MainWindow", "Загрузка данных один порядок"))
        self.pushButtonBack.setText(_translate("MainWindow", "Назад"))
        self.pushButtonNext.setText(_translate("MainWindow", "Вперед"))
        self.pushButtonDownload1.setText(_translate("MainWindow", "Загрузка данных второй порядок"))
