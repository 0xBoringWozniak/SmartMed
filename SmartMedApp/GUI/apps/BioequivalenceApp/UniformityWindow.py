...
class UniformityWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(70, 35, 391, 71))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:13pt;\">Выберите способ проверки данных </span></p><p><span style=\" font-size:13pt;\"> на однородность</span></p></body></html>"))
