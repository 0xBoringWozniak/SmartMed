...
class NormalityWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(70, 30, 401, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Выберите, каким способом выполняется </span></p><p><span style=\" font-size:18pt;\">проверка данных на нормальность</span></p></body></html>"))
