...
class NormalityWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Выберите способ проверки данных </span></p><p><span style=\" font-size:18pt;\"> на нормальность</span></p></body></html>"))
