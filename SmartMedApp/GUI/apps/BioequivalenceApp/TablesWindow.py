...
class TablesWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 60, 461, 71))
        self.label_2.setObjectName("label_2")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(110, 160, 480, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBoxDistrub.setText(_translate("MainWindow", "Таблица с анализом концентраций по группам: \n AUC, максимальная концетрация,\n время достижения макс. концентрации"))
