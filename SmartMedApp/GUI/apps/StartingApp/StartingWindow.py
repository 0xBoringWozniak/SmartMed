...
class StartingWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Выберите метод исследования данных</span></p><p><span style=\" font-size:18pt;\"><br/></span></p></body></html>"))
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt;\">Подразумевает получение обощенной</span></p><p align=\"center\"><span style=\" font-size:11pt;\">информации о данных</span></p><p align=\"center\"><br/></p></body></html>"))
