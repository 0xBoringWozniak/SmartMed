...
class StartingWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt;\">Получение обобщенной</span></p><p align=\"center\"><span style=\" font-size:11pt;\">информации о данных</span></p><p align=\"center\"><br/></p></body></html>"))
