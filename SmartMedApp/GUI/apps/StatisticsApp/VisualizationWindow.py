...
class VisualizationWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(110, 30, 391, 31))
        self.label.setObjectName("label")
        self.checkBoxDot = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBoxDot.setGeometry(QtCore.QRect(140, 229, 163, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Выберите графики для визуализации</span></p></body></html>"))
