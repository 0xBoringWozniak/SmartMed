...
class BioequivalenceModule(Module, BioequivalenceDashboard):
    ...
    def _prepare_data(self):
        if self.settings['design'] == 'parallel':
            ...
            data = {'concentration_t_1': df_1_1, 'concentration_r_1': df_1_2,
                    'concentration_t_2': df_2_1, 'concentration_r_2': df_2_2}
            return data

    def _prepare_dashboard_settings(self):
        dicts_for_graphs_and_tables = [
            self.settings['graphs'], self.settings['tables']]
