...
class PredictionApp():
    ...
    def __build_connections(self, ordered_windows):
        ...
        self.choice_window.child_roc = self.rock_value_window
        self.rock_value_window.parent = self.choice_window
        self.rock_value_window.child = self.roc_anyl_window
        self.roc_anyl_window.parent = self.rock_value_window
