...
class VisualizationWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.checkBox_9, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "Бар чарт"))
        self.checkBox_9.setToolTip(_translate("MainWindow", "<html><head/><body><p align=\"center\">Это тул тип типочек молодой цыганенок я за тобой бегал месяц мразота</p></body></html>"))
        self.checkBox_9.setText(_translate("MainWindow", "Дот плот"))
